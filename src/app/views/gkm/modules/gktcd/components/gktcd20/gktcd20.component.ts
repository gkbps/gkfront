...
export class GkTcd20Component implements OnInit, OnDestroy {
  ...
  initNavBoard() {
    this.translate.get(['tcodes', 'collective', 'collectiveSubtitle','upload', 'download', 'upsert', 'inactivate', 'activate', 'mark', 'unmark', 'clean', 'history'])
      .subscribe((res)=>{

        this.title = res.tcodes + ' - ' + res.collective;
