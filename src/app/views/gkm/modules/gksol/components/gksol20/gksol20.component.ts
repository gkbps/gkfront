...
export class GkSol20Component implements OnInit, OnDestroy {

  prefix: string = 'gksol';
  public systemImagePath: string = 'modules/sol/';
  ...
  initNavBoard() {
    this.translate.get(['solution', 'collective', 'collectiveSubtitle', 'upload', 'download', 'upsert', 'inactivate', 'activate', 'mark', 'unmark', 'clean', 'history'])
      .subscribe((res)=>{
