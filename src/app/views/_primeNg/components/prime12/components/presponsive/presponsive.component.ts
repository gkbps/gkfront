...
@Component({
  selector: 'presponsive',
  templateUrl: './presponsive.html',
  styleUrls: ['./presponsive.scss'],
 })

export class PResponsive implements OnInit {
  ...
  ngOnInit() {
      ...
      this.cars = JSON.parse(JSON.stringify(this.carService.getCarsLarge()));
      this.files = JSON.parse(JSON.stringify(this.nodeService.getFiles()));
      this.cars1 = JSON.parse(JSON.stringify(this.carService.getCarsLarge()));
      this.sourceCars = JSON.parse(JSON.stringify(this.carService.getCarsLarge()));
      this.targetCars = [];
